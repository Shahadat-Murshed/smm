    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('admin.package.create')}}" aria-expanded="false">
                        <i data-feather="plus-circle" class="feather-icon text-success"></i>
                        <span class="hide-menu">@lang('Add packages')</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('admin.package.index')}}" aria-expanded="false">
                        <i data-feather="list" class="feather-icon text-purple"></i>
                        <span class="hide-menu">@lang('Show Packages')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('admin.advanced-services.create')}}" aria-expanded="false">
                        <i data-feather="plus-circle" class="feather-icon text-purple"></i>
                        <span class="hide-menu">@lang('Advanced Services')</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('admin.advanced-services.index')}}" aria-expanded="false">
                        <i data-feather="list" class="feather-icon text-success"></i>
                        <span class="hide-menu">@lang('Show A. Services')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{ route('admin.tiers') }}"
                       aria-expanded="false">
                        <i class="fas fa-cogs text-success"></i>
                        <span class="hide-menu">@lang('Tiers')</span>
                    </a>
                </li>
                <li class="list-divider"></li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('admin.super.payment.methods')}}"
                       aria-expanded="false">
                ...
                <li class="sidebar-item {{menuActive(['admin.super.deposit.manual.index','admin.super.deposit.manual.create','admin.super.deposit.manual.edit'],3)}}">
                    <a class="sidebar-link" href="{{route('admin.super.deposit.manual.index')}}"
                       aria-expanded="false">
