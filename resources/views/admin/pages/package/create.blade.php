...
@section('content')
    <div class="card card-primary card-form m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body ">
            <form action="{{route('admin.package.store')}}" method="POST" class="form">
                @csrf
                <h5 class="table-group-title text-info mb-2 mb-md-3"><span>@lang('Package')</span></h5>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple form-control" name="category">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('category->id') == $category->id ? 'selected' : '' }}>{{ $category->category_title }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div id="service}">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label " for="services">@lang('Service')</label>
                                <select id="search-adv" class="form-control js-example-basic-multiple form-control" name="services[]" multiple="multiple">
                                    <option value="0" hidden>@lang('Select service name')</option>
                                    @foreach($advanced_services as $service)
                                        <option value="{{ $service->id }}" {{ old('advanced_service_id') == $service->id ? 'selected' : '' }}>{{ $service->service_title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div id="adv-table" class="col-md-12 d-none table-responsive">
                ...
                <div class="divider"></div>
                <h5 class="table-group-title text-primary mb-2 mb-md-3"><span>@lang('Price')</span></h5>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group ">
                            <label>@lang('Package Price (One Time)')</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="number" name="price_annually" value="{{ old('price_annually') }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="point_1" value="{{ old('point_1') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="point_2" value="{{ old('point_2') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="point_3" value="{{ old('point_3') }}"
                ...
                <div class="divider"></div>
                <h5 class="table-group-title text-primary mb-2 mb-md-3"><span>@lang('Additional Days')</span></h5>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group ">
                            <label>@lang('Additional Days?')</label>
                            <input type="number" name="additional_days" value="{{ old('additional_days') }}"
