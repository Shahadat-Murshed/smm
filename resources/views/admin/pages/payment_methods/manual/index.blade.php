        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary shadow">
                    <div class="card-body">
                        <a href="{{route('admin.super.deposit.manual.create')}}" class="btn btn-success btn-sm float-right mb-3"><i class="fa fa-plus-circle"></i> {{trans('Add New')}}</a>
                                ...
                                @foreach($methods as $method)
                                    <tr data-code="{{ $method->code }}">
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('admin.super.deposit.manual.edit', $method->id) }}"
    ...
    <div id="disableModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.super.payment.methods.deactivate') }}" method="POST">
                    @csrf
