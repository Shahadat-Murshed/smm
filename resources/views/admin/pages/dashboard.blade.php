                        ...
                        <div class="table-responsive">
                            <table class="categories-show-table table table-hover table-striped table-bordered text-right text-lg-center">
                                ...
                                @foreach($bestSale as $sale)
                                    <tr>
                                        <td data-label="@lang('ID')">@lang($sale->category->id)</td>
                                        <td data-label="@lang('Name')" class="text-right text-lg-left">

                                            <a href="javascript:void(0)" data-container="body"  data-toggle="popover" data-placement="top" data-content="{{optional($sale->category)->category_title}}">
                                                {{\Str::limit(optional($sale->category)->category_title, 30)}}
                                            </a>
                                        </td>
                                        ...
                                        <td data-label="@lang('Provider')" class="text-right text-lg-left">
                                            @php
                                                $jsonData  = json_decode($sale->service_details, true);
                                            @endphp
                                            {{data_get($jsonData, 'api_providers.api_name')}}
                                        </td>
                                            ...
                                            <div class="dropdown show dropup">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.service.edit',['id'=>$sale->category->id])}}">
                                                    ...
                                                    <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                                            ...
                                                            data-servicetitle="{{$sale->category->category_title}}"
                                                            data-description="{{$sale->category->category_description}}">
