                ...
                <ul class="navbar-nav ml-auto  align-items-end align-items-sm-center">
                    ...
                    <li class="nav-item dropdown {{ Request::routeIs('user.order*') ? 'active' : '' }}">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            {{-- <a class="dropdown-item {{menuActive('user.orderV2.create')}}" href="{{ route('user.orderV2.create') }}">@lang('New Order')</a> --}}
                            <a class="dropdown-item {{menuActive('user.order.index')}}" href="{{ route('user.orderV2.index') }}">@lang('All Order')</a>
                        </div>
                    </li>

                    @if(Auth::user()->role == 'Affiliate' || "Ambassador")
                        <li class="nav-item dropdown {{ Request::routeIs(['user.service*', 'user.affiliate*']) ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @lang('Refer & Earn')
                                <i data-feather="chevron-down" class="svg-icon"></i>
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item {{menuActive('user.order.index')}}"
                                href="{{ route('user.affiliate.package') }}">@lang('Packages') </a>
                            </div>
                        </li>
                    @endif
                    ...
                    <li class="nav-item  ">
                        <a class="nav-link
                            {{ Request::routeIs('user.refer.affiliate.*')  ? 'active' : '' }}
                            "
                           href="{{route('user.refer.affiliate.create')}}"
                        >@lang('Affiliate Zone')
                        </a>
                    </li>
                    @endif
