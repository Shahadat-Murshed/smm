...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $order['total'] = AdvOrder::where('user_id', $this->user->id)->count();
        $order['processing'] = AdvOrder::where('user_id', $this->user->id)->where('status', 'processing')->count();
        $order['pending'] = AdvOrder::where('user_id', $this->user->id)->where('status', 'pending')->count();
        $order['completed'] = AdvOrder::where('user_id', $this->user->id)->where('status', 'completed')->count();
