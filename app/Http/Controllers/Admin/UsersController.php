...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $refferals = Referral::get();
        return view('admin.pages.users.show-user', compact('users', 'refferals'));
    }
    ...
    public function activeMultiple(Request $request)
    {
        ...
        if ($request->strIds == null) {
            session()->flash('error', 'You did not select Anyone.');
    ...
    public function promoActiveMultiple(Request $request)
    {
        ...
        if ($request->strIds == null) {
            ...
            session()->flash('success', 'Users Promo Privilage Has Been Actived');
            return response()->json(['success' => 1]);
        }
    }


    public function promoInactiveMultiple(Request $request)
    {
        ...
        if ($request->strIds == null) {
            ...
            session()->flash('success', 'Users Promo Privilage Has Been Deactived');
            return response()->json(['success' => 1]);

        }
    }

    public function promoGenerate(Request $request, $id){
        $user = User::findOrFail($id);
    ...
    public function promoUpdate(Request $request, $id){
        ...
        if(User::where('promo_code', $request->promo_code)->exists()){
    ...
    {
        $user = User::findOrFail($id);
        return view('admin.pages.users.change-role', compact('user'));
    }
